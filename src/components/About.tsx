...
const machines = [
  {
    ...
    description: "Обеспечивает идеально точный раскрой ЛДСП, МДФ и ХДФ плит строго по размерам чертежа. Никаких сколов на ламинате и отклонений по диагонали — детали стыкуются без зазоров.",
  },
  {
    icon: Layers,
    stage: "Кромкооблицовка (Клейка)",
    machineName: "Кромкооблицовочный станок",
    description: "Кромка ПВХ и АБС наносится под высокой температурой и давлением. Клеевой шов герметичен — это защищает мебель от проникновения влаги, разбухания и сколов на торцах.",
  },
  {
    icon: Settings2,
    stage: "Присадка (Сверление)",
    machineName: "Сверлильно-присадочный станок",
    description: "Выполняет высокоточное сверление глухих и сквозных отверстий под мебельную фурнитуру. Благодаря этому петли, направляющие и стяжки монтируются ровно, без перекосов.",
  },
  {
    icon: Hammer,
    stage: "Кастомизация и доводка",
    machineName: "Фрезерный и вспомогательный инструмент",
    description: "Профессиональные ручные фрезеры и шлифовальные машины для изготовления сложных радиусных элементов, нестандартных деталей и идеальной подгонки мебели при сборке.",
  },
];
          ...
          <Reveal delay={100}>
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                Мы производим корпусную мебель в Жезказгане уже **более 15 лет**. Главный принцип нашей работы — полная независимость. Все технологические операции выполняются в нашем собственном цеху на профессиональном оборудовании.
              </p>
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-2">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                      Мы не передаем распил или кромление сторонним организациям. Это исключает посреднические наценки и гарантирует честную цену.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                      Каждая деталь проходит строгий контроль на стадиях резки, клейки и присадки. Мы лично отвечаем за долговечность вашей мебели.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-20 border-t border-border pt-16">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Современное техническое оснащение позволяет нам изготавливать мебель любой сложности с заводской точностью и высоким качеством стыков.
              </p>
            </div>
          </Reveal>
          ...
          <ul className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {machines.map((machine, i) => (
              <Reveal as="li" key={machine.machineName} delay={i * 70} className="bg-background rounded-sm border border-border p-6 flex flex-col justify-between">
                <div>
