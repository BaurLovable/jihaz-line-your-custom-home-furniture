            ...
            <ul className="grid gap-px overflow-hidden rounded-sm border border-border bg-border sm:grid-cols-2">
              <li className="bg-card p-5 flex flex-col justify-between min-h-[140px]">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Прямой звонок для консультации</p>
                </div>
                <a
                  href={site.phoneHref}
              ...
              <li className="bg-card p-5 flex flex-col justify-between min-h-[140px]">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Быстрое обсуждение деталей и расчет</p>
                </div>
                <a
              ...
              <li className="bg-card p-5 flex flex-col justify-between min-h-[140px]">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Связь с менеджером в мессенджере</p>
                </div>
                <a
                  href={site.telegram}
                  target="_blank"
