...
const shots = [
  ...
  { src: inside, alt: "Внутреннее наполнение выдвижного ящика с разделителями", caption: "Внутреннее наполнение" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-sm text-muted-foreground">
            Раздел подготовлен для фотографий выполненных работ. Сейчас показаны визуальные
            примеры решений.
          </p>
        </Reveal>
